...
import { TransitionContext, type TransitionContextState } from "@features/visual-effects";
...
export default function useTransitionScreen(): TransitionContextState {
  ...
  if (!context) {
    throw new Error("useTransitionScreen must be used within TransitionProvider");
  }
